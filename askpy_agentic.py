...
from getpass import getpass
import os
os.environ["MCP_ENDPOINT"] = getpass("Enter your MCP endpoint: ")
...
# if not mcp_endpoint:
#     raise ValueError("Please set the MCP_ENDPOINT environment variable!")
# 
...
# 
#             # Root observation in Langfuse
#             with langfuse.start_as_current_observation(
#                 as_type="span",
#                 name="AskPy User Question"
#             ):
# 
#                 # MCP Agent call inside generation observation
#                 with langfuse.start_as_current_observation(
#                     as_type="generation",
#                     name="MCP Agent Generation"
#                 ) as span:
# 
#                     # Run the Agent via MCP
#                     answer = mcp_client.run_tool("AskPyAgent", query)
# 
